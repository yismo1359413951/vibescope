...
enum SettingsTab: String, CaseIterable, Identifiable {
    ...
    func label(_ lang: LanguageManager) -> String {
        ...
        case .autoApprove: lang.t("settings.tab.autoApprove")
    ...
    var icon: String {
        ...
        case .autoApprove: "checkmark.shield.fill"
    ...
    var section: SettingsSection {
        switch self {
        case .general, .setup, .autoApprove, .display, .sound, .appearance, .watch: .system
...
struct SettingsView: View {
    ...
    private var detailView: some View {
        ZStack(alignment: .topTrailing) {
            ...
            case .autoApprove:
                AutoApproveSettingsPane(model: model)
            case .appearance:
