...
brand_icon="$repo_root/Assets/Brand/ZiweiVibeScope.icns"
bundle_dir="$HOME/Applications/紫微 VibeScope.app"
...
python3 "$brand_script" 2>/dev/null || true
...
osascript -e 'tell application "紫微 VibeScope" to quit' 2>/dev/null || true
pkill -9 -f "紫微 VibeScope" 2>/dev/null || true
